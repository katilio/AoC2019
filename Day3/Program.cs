...
namespace Day3
{
    class Program
    {
        public static Dictionary<(int, int), int> MakeWire(string input)
        {
            ...
            foreach (string direction in directions)
            {
                ...
                {
                    case ('U'):
                        for (int moves = 0; moves < Int32.Parse(direction.Substring(1)); moves++)
                        {
                            Dict.TryAdd((x, ++y), steps++);
                        }
                        break;
                    case ('D'):
                        for (int moves = 0; moves < Int32.Parse(direction.Substring(1)); moves++)
